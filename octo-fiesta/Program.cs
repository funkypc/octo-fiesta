...
else if (musicService == MusicService.YouTubeMusic)
{
    ...
    builder.Services.AddSingleton<YouTubeMusicBridgeService>();
...
builder.Services.AddHttpClient("YouTubeMusic", YouTubeMusicHttpClientConfiguration.ConfigureClient);
